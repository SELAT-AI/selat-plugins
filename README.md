...
(`@selat-ai/selat-cli@0.16.19 --ignore-scripts` — not `@latest`). Agents: the step-by-step
...
> [guides/generic.md](guides/generic.md): `npm i -g @selat-ai/selat-cli@0.16.19 --ignore-scripts`
...
| Any other / none | [guides/generic.md](guides/generic.md) | `npm i -g @selat-ai/selat-cli@0.16.19 --ignore-scripts` then `selat init` (not `@latest`) |
