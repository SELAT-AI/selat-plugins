...
> command surface below was verified against @selat-ai/selat-cli@0.17.1 and
...
## Command quick reference (selat-cli v0.17.1)
...
> Flag surface verified against @selat-ai/selat-cli@0.17.1 (`lib/commands/run.mjs`,
> `lib/commands/skill.mjs`) and @selat-ai/selat-discovery@0.25.0:
