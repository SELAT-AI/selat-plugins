...
> command surface below was verified against @selat-ai/selat-cli@0.12.0 and
...
## Command quick reference (selat-cli v0.12.0)
...
> Flag surface verified against @selat-ai/selat-cli@0.12.0 (`lib/commands/run.mjs`,
