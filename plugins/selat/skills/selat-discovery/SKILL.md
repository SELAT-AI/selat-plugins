...
> command surface below was verified against @selat-ai/selat-cli@0.15.7 and
...
## Command quick reference (selat-cli v0.15.7)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.7 (`lib/commands/run.mjs`,
