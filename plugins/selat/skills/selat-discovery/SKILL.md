...
> command surface below was verified against @selat-ai/selat-cli@0.15.6 and
> @selat-ai/selat-discovery@0.17.0.
...
> Flag surface verified against @selat-ai/selat-cli@0.15.6 (`lib/commands/run.mjs`,
> `lib/commands/skill.mjs`) and @selat-ai/selat-discovery@0.17.0:
