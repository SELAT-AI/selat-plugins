...
> command surface below was verified against @selat-ai/selat-cli@0.15.10 and
...
## Command quick reference (selat-cli v0.15.10)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.10 (`lib/commands/run.mjs`,
