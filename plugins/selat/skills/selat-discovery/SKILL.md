...
> command surface below was verified against @selat-ai/selat-cli@0.15.8 and
...
## Command quick reference (selat-cli v0.15.8)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.8 (`lib/commands/run.mjs`,
