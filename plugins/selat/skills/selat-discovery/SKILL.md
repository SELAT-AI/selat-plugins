...
> command surface below was verified against @selat-ai/selat-cli@0.9.0 and
...
## Command quick reference (selat-cli v0.9.0)
...
> Flag surface verified against @selat-ai/selat-cli@0.9.0 (`lib/commands/run.mjs`,
