...
> command surface below was verified against @selat-ai/selat-cli@0.15.5 and
> @selat-ai/selat-discovery@0.16.0.
...
> Flag surface verified against @selat-ai/selat-cli@0.15.5 (`lib/commands/run.mjs`,
> `lib/commands/skill.mjs`) and @selat-ai/selat-discovery@0.16.0:
