...
> command surface below was verified against @selat-ai/selat-cli@0.8.3 and
...
## Command quick reference (selat-cli v0.8.3)
...
> Flag surface verified against @selat-ai/selat-cli@0.8.3 (`lib/commands/run.mjs`,
