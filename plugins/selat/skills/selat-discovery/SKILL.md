...
> command surface below was verified against @selat-ai/selat-cli@0.11.0 and
...
## Command quick reference (selat-cli v0.11.0)
...
> Flag surface verified against @selat-ai/selat-cli@0.11.0 (`lib/commands/run.mjs`,
