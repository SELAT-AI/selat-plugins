...
> command surface below was verified against @selat-ai/selat-cli@0.9.4 and
...
## Command quick reference (selat-cli v0.9.4)
...
> Flag surface verified against @selat-ai/selat-cli@0.9.4 (`lib/commands/run.mjs`,
