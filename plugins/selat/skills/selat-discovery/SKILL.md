...
> command surface below was verified against @selat-ai/selat-cli@0.15.2 and
> @selat-ai/selat-discovery@0.14.0.
...
## Command quick reference (selat-cli v0.15.2)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.2 (`lib/commands/run.mjs`,
> `lib/commands/skill.mjs`) and @selat-ai/selat-discovery@0.14.0:
