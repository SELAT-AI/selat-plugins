...
> command surface below was verified against @selat-ai/selat-cli@0.15.19 and
> @selat-ai/selat-discovery@0.20.0.
...
## Command quick reference (selat-cli v0.15.19)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.19 (`lib/commands/run.mjs`,
