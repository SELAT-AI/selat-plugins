...
> command surface below was verified against @selat-ai/selat-cli@0.15.3 and
...
## Command quick reference (selat-cli v0.15.3)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.3 (`lib/commands/run.mjs`,
