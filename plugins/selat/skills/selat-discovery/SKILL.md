...
> command surface below was verified against @selat-ai/selat-cli@0.15.1 and
...
## Command quick reference (selat-cli v0.15.1)
...
> Flag surface verified against @selat-ai/selat-cli@0.15.1 (`lib/commands/run.mjs`,
