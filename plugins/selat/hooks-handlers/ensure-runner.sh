...
# plugin-owned dir, NOT a selat-cli home — verified against selat-cli@0.15.14, selat-cli
...
#
# Verified against @selat-ai/selat-cli@0.15.14 (lib/commands/doctor.mjs + bin/selat.mjs):
