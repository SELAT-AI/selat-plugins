...
# plugin-owned dir, NOT a selat-cli home — verified against selat-cli@0.9.0, selat-cli
...
# pin by exporting SELAT_CLI_SPEC=0.9.0 (a concrete version skips the registry check).
...
#
# Verified against @selat-ai/selat-cli@0.9.0 (lib/commands/doctor.mjs + bin/selat.mjs):
