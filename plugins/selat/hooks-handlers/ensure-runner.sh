...
# plugin-owned dir, NOT a selat-cli home — verified against selat-cli@0.15.6, selat-cli
...
# pin by exporting SELAT_CLI_SPEC=0.15.6 (a concrete version skips the registry check).
...
#
# Verified against @selat-ai/selat-cli@0.15.6 (lib/commands/doctor.mjs + bin/selat.mjs):
